...
import { CoinInfo } from "./components/coin-info/coin-info.tsx";
import { Graf } from "./components/coin-graf/index.js";
import { CoinTools } from './components/coin-tools/index.tsx';
import { CoinHeader } from "./components/coin-header/index.js";
import { useGrafData } from './hooks/useGrafData';
import { useCoinStore } from '../../store/CoinStore.ts';
import { Header } from '@/components/header/index.tsx';
import { SectionCards } from './components/section-cards/coin-info-lg.tsx'
